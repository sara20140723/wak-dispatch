...
@MapperScan(basePackages = "com.wak.dispatch.dao.workstation", sqlSessionTemplateRef  = "db2SqlSessionTemplate")
...
//    private PagePlugin pagePlugin;
    ...
    @ConfigurationProperties(prefix = "wak.datasources.workstation")
...
//        bean.setPlugins(new Interceptor[]{pagePlugin});
        ...
        // 设置mapper映射文件
        bean.setMapperLocations(new PathMatchingResourcePatternResolver().getResources("classpath:mybatis/mapper/workstation/*.xml"));
